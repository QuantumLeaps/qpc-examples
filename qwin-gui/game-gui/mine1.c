...
#endif
//$endskip${QP_VERSION} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
//$define${App::Mine1_ctor_call} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv

//${App::Mine1_ctor_call} ....................................................
QAsm * Mine1_ctor_call(uint8_t id) {
    Q_REQUIRE(id < GAME_MINES_MAX);
    Mine1 * const me = &Mine1_inst[id];
    Mine1_ctor(me);
    return Q_ASM_UPCAST(me);
}
//$enddef${App::Mine1_ctor_call} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
static QState Mine1_initial(Mine1 * const me, void const * const par) {
    ...
    if (!dict_sent) {
        ...
        QS_FUN_DICTIONARY(&Mine1_initial);
