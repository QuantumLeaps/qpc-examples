...
static void paintBits(uint8_t x, uint8_t y,
...
void QF_onClockTick(void) {
    //QTIMEEVT_TICK_X(0U, &l_clock_tick); // time events at rate 0
    QTICKER_TRIG(&QTicker_inst0, &l_clock_tick); // trigger ticker AO
