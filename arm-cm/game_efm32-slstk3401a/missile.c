...
//${App::AO_Missile} .........................................................
QActive * const AO_Missile = Q_ACTIVE_UPCAST(&Missile_inst);
//$enddef${App::AO_Missile} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

// Active object definition ------------------------------------------------
//$define${App::Missile_ctor_call} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv

//${App::Missile_ctor_call} ..................................................
void Missile_ctor_call(void) {
    Missile_ctor(&Missile_inst);
}
//$enddef${App::Missile_ctor_call} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
