...
# DPP on NUCLEO-H533RE
This example demonstrates the [Dining Philosophers Problem (DPP) application](https://www.state-machine.com/qpc/tut_dpp.html) on the STM32 NUCLEO-H533RE board (ARM Cortex-__M33__).

<p align="center">
<img src="stm32-nucleo-h533re.webp"/><br>
<b>STM32 NUCLEO-H533RE</b>
</p>
...
# Code Organization
```
examples\arm-cm\dpp_nucleo-h533re
|
...
- change to the desired directory (either `examples\arm-cm\dpp_nucleo-h533re\qk\gnu`, `examples\arm-cm\dpp_nucleo-h533re\qv\gnu`, or `examples\arm-cm\dpp_nucleo-h533re\qxk\gnu`)
