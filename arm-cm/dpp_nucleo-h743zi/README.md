...
This example demonstrates the [Dining Philosophers Problem (DPP) application](https://www.state-machine.com/qpc/tut_dpp.html) on the STM32 NUCLEO-H743ZI board (ARM Cortex-M7 with double-precision FPU).
...
# Code Organization
```
examples\arm-cm\dpp_nucleo-h743zi
|
...
- change to the desired directory (either `examples\arm-cm\dpp_nucleo-h743zi\qk\gnu`, `examples\arm-cm\dpp_nucleo-h743zi\qv\gnu`, or `examples\arm-cm\dpp_nucleo-h743zi\qxk\gnu`)
