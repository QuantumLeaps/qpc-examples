...
This example demonstrates the [Dining Philosophers Problem (DPP) application](https://www.state-machine.com/qpc/tut_dpp.html) on the STM32 NUCLEO-L053R8 board (ARM Cortex-M0+).
...
# Code Organization
```
examples\arm-cm\dpp_nucleo-l053r8
|
...
- change to the desired directory (either `examples\arm-cm\dpp_nucleo-l053r8\qk\gnu`, `examples\arm-cm\dpp_nucleo-l053r8\qv\gnu`, or `examples\arm-cm\dpp_nucleo-l053r8\qxk\gnu`)
