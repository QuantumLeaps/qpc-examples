...
// the only instance of Blinky
static Blinky Blinky_inst;

// the opaque pointer to the Blinky Active Object
QActive * const AO_Blinky = &Blinky_inst.super;

// the "constructor" of the Blinky Active Object (called from main)
...
static QState Blinky_initial(Blinky * const me, void const * const par) {
    ...
    Q_UNUSED_PAR(par); // unused initialization parameter
