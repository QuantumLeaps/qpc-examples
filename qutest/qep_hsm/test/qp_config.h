...
//
// The SafeQP/C software is dual-licensed under the terms of the open-source GNU
...
// incorporation of the SafeQP/C software into proprietary programs. Please
// contact Quantum Leaps for commercial licensing options, which expressly
// supersede the GPL and are designed explicitly for licensees interested
// in using SafeQP/C in closed-source proprietary applications.
//
