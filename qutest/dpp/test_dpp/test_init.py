...
def on_reset():
    ...
    expect("===RTC===> St-Init  Obj=Philo_inst[0],State=NULL->Philo_thinking")
    ...
    expect("===RTC===> St-Init  Obj=Philo_inst[1],State=NULL->Philo_thinking")
    expect("@timestamp BSP_CALL BSP_random *")
    ...
    expect("===RTC===> St-Init  Obj=Philo_inst[3],State=NULL->Philo_thinking")
    expect("@timestamp BSP_CALL BSP_random *")
    ...
    expect("===RTC===> St-Init  Obj=Philo_inst[4],State=NULL->Philo_thinking")
    expect("@timestamp BSP_CALL BSP_random *")
